...
let TaxRatesService = class TaxRatesService {
    ...
    async addTaxRate({ state, postalCode, taxRate }) {
        ...
        return ResponseHandler_1.default.success(newTaxRate, 'Tax rate added successfully.');
    }
    async getTaxRateByPostalCode(postalCode) {
        const taxRate = await this.taxRateModel
            ...
            .exec();
        return ResponseHandler_1.default.success(taxRate);
    }
};
TaxRatesService = __decorate([
    common_1.Injectable(),
    __param(0, mongoose_1.InjectModel('tax-rates')),
