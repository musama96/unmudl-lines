...
exports.CourseDraftSchema = new mongoose.Schema({
...
exports.CourseDraftSchema.query.byKeyword = function (keyword) {
    return this.where({
        title: {
            $regex: keyword,
            $options: 'i',
...
exports.CourseDraftSchema.query.paginate = function (page, perPage) {
    return this.skip((page - 1) * perPage).limit(perPage);
};
//# sourceMappingURL=course-draft.model.js.map