...
class ListDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { keyword: { required: true, type: () => String }, page: { required: true, type: () => Number }, perPage: { required: true, type: () => Number }, collegeId: { required: false, type: () => String }, start: { required: true, type: () => String }, end: { required: true, type: () => String } };
    }
}
__decorate([
