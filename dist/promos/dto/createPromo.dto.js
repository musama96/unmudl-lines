...
class CreatePromoDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { title: { required: true, type: () => String }, discount: { required: true, type: () => Number }, discountMetric: { required: true, enum: require("../../common/enums/createPromo.enum").DiscountMetric }, date: { required: true, type: () => require("../../common/dto/duration.dto").DurationDto }, applyTo: { required: false, enum: require("../../common/enums/createPromo.enum").ApplyTo }, type: { required: false, enum: require("../../common/enums/createPromo.enum").DiscountCut }, courses: { required: false, type: () => [String] }, collegeId: { required: false, type: () => String } };
    }
}
__decorate([
...
__decorate([
    swagger_1.ApiHideProperty(),
    __metadata("design:type", String)
], CreatePromoDto.prototype, "addedBy", void 0);
__decorate([
    swagger_1.ApiHideProperty(),
    __metadata("design:type", String)
], CreatePromoDto.prototype, "addedByLearner", void 0);
__decorate([
