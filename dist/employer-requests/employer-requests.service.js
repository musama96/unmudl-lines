...
let EmployerRequestsService = class EmployerRequestsService {
    constructor(employerRequestModel, userModel, mailerService, emailLogsService) {
        this.employerRequestModel = employerRequestModel;
    ...
    async createEmployerRequest(employerRequest) {
        ...
        return ResponseHandler_1.default.success(newEmployerRequest);
    }
    async getEmployerRequests(params) {
    ...
    async getEmployerRequestsCsv(params) {
...
EmployerRequestsService = __decorate([
    common_1.Injectable(),
    __param(0, mongoose_1.InjectModel('employer-requests')),
...
exports.EmployerRequestsService = EmployerRequestsService;
//# sourceMappingURL=employer-requests.service.js.map