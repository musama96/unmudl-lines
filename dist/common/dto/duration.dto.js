...
class DurationDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { start: { required: true, type: () => String }, end: { required: false, type: () => String }, collegeId: { required: false, type: () => String } };
    }
}
__decorate([
...
], DurationDto.prototype, "start", void 0);
__decorate([
