...
class DashboardDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { repliesPerPage: { required: false, type: () => Number }, postsPerPage: { required: false, type: () => Number }, start: { required: false, type: () => String }, end: { required: false, type: () => String } };
    }
}
__decorate([
...
], DashboardDto.prototype, "repliesPerPage", void 0);
__decorate([
    swagger_1.ApiProperty({ required: false, default: '4' }),
    class_validator_1.IsOptional(),
    __metadata("design:type", Number)
], DashboardDto.prototype, "postsPerPage", void 0);
__decorate([
