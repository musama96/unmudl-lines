...
], CollegesListDto.prototype, "keyword", void 0);
__decorate([
    swagger_1.ApiProperty({ required: false, default: '1' }),
    class_validator_1.IsOptional(),
    __metadata("design:type", Number)
], CollegesListDto.prototype, "page", void 0);
__decorate([
    swagger_1.ApiProperty({ required: false, default: '10' }),
    class_validator_1.IsOptional(),
    __metadata("design:type", Number)
], CollegesListDto.prototype, "perPage", void 0);
__decorate([
    swagger_1.ApiProperty({ required: false, default: '' }),
    validators_1.IsMongoId(true, { message: responseMessages_1.default.common.invalidCollegeId }),
    __metadata("design:type", String)
], CollegesListDto.prototype, "collegeId", void 0);
__decorate([
    swagger_1.ApiProperty({ required: false, default: '' }),
    validators_1.IsMongoId(true, { message: responseMessages_1.default.common.invalidEmployerId }),
    __metadata("design:type", String)
], CollegesListDto.prototype, "employerId", void 0);
__decorate([
    swagger_1.ApiProperty({ required: false, default: '' }),
    validators_1.IsMongoId(true, { message: responseMessages_1.default.common.invalidCourseId }),
    __metadata("design:type", String)
], CollegesListDto.prototype, "courseId", void 0);
__decorate([
    swagger_1.ApiProperty({ required: false, default: '' }),
    validators_1.IsMongoId(true, { message: responseMessages_1.default.common.invalidLearnerId }),
    __metadata("design:type", String)
], CollegesListDto.prototype, "learnerId", void 0);
__decorate([
    swagger_1.ApiProperty({ description: 'State short name.' }),
    __metadata("design:type", String)
], CollegesListDto.prototype, "state", void 0);
exports.CollegesListDto = CollegesListDto;
//# sourceMappingURL=collegesList.dto.js.map