...
LocationsModule = __decorate([
    common_1.Module({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: 'states', schema: state_model_1.StateSchema }]),
            mongoose_1.MongooseModule.forFeature([{ name: 'countries', schema: country_model_1.CountrySchema }]),
        ],
